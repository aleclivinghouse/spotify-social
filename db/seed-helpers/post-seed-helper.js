...
const postSeedHelper = function(type){
    const post = {};
    switch (type) {
        case "fire_lyric":
          ...
          post.rating = null;
          post.trackId = Math.floor(Math.random() * 5) + 1;
          return post;
          break;
        ...
        case "recommend_a_track":
            ...
            post.text = faker.lorem.sentence();
            post.trackId = Math.floor(Math.random() * 70) + 1;
          return post;
          break;
        case "rate_an_album":
            post.title = faker.lorem.words();
            ...
            post.text = faker.lorem.sentence();
            post.albumId = Math.floor(Math.random() * 5) + 1;
            return post;
            break;
        case "recommend_an_artist":
            ...
            post.text = faker.lorem.sentence();
            post.artistId = Math.floor(Math.random() * 8) + 1;
            return post;
            break;
      }
}

module.exports = postSeedHelper;